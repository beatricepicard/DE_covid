...
def line_chart(data, scope_title):
    ...
    with col1:
        ...
        fig_cases.update_layout(height=250, margin=dict(t=40, b=5, l=50, r=15))
    ...
    with col2:
        ...
        fig_deaths.update_layout(height=250, margin=dict(t=40, b=5, l=50, r=15))
    ...
    with col3:
        ...
        fig_recoveries.update_layout(height=250, margin=dict(t=40, b=5, l=50, r=15))
    ...
    with col4:
        ...
        fig_total_cases.update_layout(height=250, margin=dict(t=40, b=5, l=50, r=15))
    ...
    with col5:
        ...
        fig_total_deaths.update_layout(height=250, margin=dict(t=40, b=5, l=50, r=15))
    ...
    with col6:
        ...
        fig_total_recovered.update_layout(height=250, margin=dict(t=40, b=5, l=50, r=15))
